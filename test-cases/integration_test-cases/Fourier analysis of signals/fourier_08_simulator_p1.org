...
* Test Steps
  ...
  4. Click on "Relationship between CTFS and CTFT (for aperiodic signal)" link.
...
* Expected result
  ...
  4. The zip file of "Relationship between CTFS and CTFT (for aperiodic signal)" should get downloaded to your machine.
